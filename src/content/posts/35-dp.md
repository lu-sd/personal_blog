---
title: "classic DP Algo-64,322,518,377,1143,300,368"
...
function coinChange(coins: number[], amount: number): number {
  ...
  // dp[j - coins[i]] + 1: The number of coins needed if you include the current coin.
  //  and +1 accounts for using one coin of the current denomination.
  for (let i = 0; i < coins.length; i++) {
    for (let j = coins[i]; j <= amount; j++) {
